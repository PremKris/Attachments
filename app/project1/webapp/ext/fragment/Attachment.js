sap.ui.define([
    ...
    return {
        ...
        onAfterItemAdded: function(oEvent) {
			...
			onUploadCompleted: function (oEvent) { debugger;
				var oUploadSet = this.byId("uploadSet");
				oUploadSet.removeAllIncompleteItems();
				oUploadSet.getBinding("items").refresh();
			},

			onRemovePressed: function (oEvent) { debugger;
			...
			_createEntity: function (item) { debugger;
				var data = {
					mediaType: item.getMediaType(),
					fileName: item.getFileName(),
					size: item.getFileObject().size
			...
			_uploadContent: function (item, id) { debugger;
			...
			//formatters
			formatThumbnailUrl: function (mediaType) { debugger;
				var iconUrl;
				switch (mediaType) {
					case "image/png":
